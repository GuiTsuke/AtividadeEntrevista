...
$(document).ready(function () {
    $('#btnBeneficiariosModal').click(function () {
        if (atualizar == 0) {
            $.ajax({
...
function atualizarGrid(beneficiarios) {
    ...
    tbody.empty();
    idCliente = beneficiarios[0].IdCliente;
    beneficiarios.forEach(function (beneficiario, index) {
        ...
        var btnExcluir = $('<button>').text('Excluir').addClass('btn btn-danger btn-sm');
        ...
        btnAlterar.click(function () {
            ...
            RemoverBeneficiario(beneficiario.CPF);
